...
// WithPlatformMatcherMap sets the platform matcher map on the client
func WithPlatformMatcherMap(platformMatcherMap map[string]platforms.MatchComparer) Opt {
	return func(c *clientOpts) error {
