...
func (c *CRIImageService) LocalResolve(refOrID, platform string) (imagestore.Image, error) {
...
func (c *CRIImageService) GetImage(id, platform string) (imagestore.Image, error) {
	return c.imageStore.Get(id, platform)
}
