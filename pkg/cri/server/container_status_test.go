...
func (s *fakeImageService) GetImage(id, runtimeHandler string) (imagestore.Image, error) {
...
func (s *fakeImageService) LocalResolve(refOrID, runtimeHandler string) (imagestore.Image, error) {
