...
func (c *criService) CreateContainer(ctx context.Context, r *runtime.CreateContainerRequest) (_ *runtime.CreateContainerResponse, retErr error) {
	...
	platformForRuntimeHandler, err := criconfig.GetPlatformForRuntimeHandler(c.config.ContainerdConfig, sandbox.RuntimeHandler)
	if err != nil {
		return nil, fmt.Errorf("failed to get platform for runtime handler %v", sandbox.RuntimeHandler)
	}
	image, err := c.LocalResolve(config.GetImage().GetImage(), platformForRuntimeHandler)
	if err != nil {
